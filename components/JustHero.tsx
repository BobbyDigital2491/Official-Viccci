  ...
  return (
    ...
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        ...
        <div className="mt-5 sm:mt-10 lg:mt-0">
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-2 md:space-y-4">
              <h2 className="font-bold text-3xl lg:text-4xl text-red-600 dark:text-red-600">
        ...
        <a className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-red-600 text-white hover:bg-red-700 focus:outline-none focus:bg-red-700 disabled:opacity-50 disabled:pointer-events-none" href="https://www.eventbrite.com/e/ivory-lattas-just-believe-art-experience-tickets-945998275307?fbclid=IwY2xjawEUo4BleHRuA2FlbQIxMAABHf7RQcTLu75W99HilB2PugB1XUoW9ektLPMXSzbFDVim2pB0ilI5RSBkIQ_aem_6Jwkwe9e-yc_v8PCnesMoQ">
          Get Tickets
