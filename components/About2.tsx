...
const About2 = () => {
  return (
    ...
    <div className="container px-6 py-10 mx-auto">
        <h1 className="text-2xl font-semibold text-white capitalize lg:text-3xl dark:text-white">Take a look <br/> at our <span className="underline decoration-sky-500">tokenomics</span></h1>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="space-y-3">
                ...
                <h1 className="text-xl font-semibold text-white capitalize dark:text-white">Zero Configrations</h1>
            ...
            <div className="space-y-3">
                ...
                <h1 className="text-xl font-semibold text-white capitalize dark:text-white">New Components Every month</h1>
            ...
            <div className="space-y-3">
                ...
                <h1 className="text-xl font-semibold text-white capitalize dark:text-white">Easy to customiztions</h1>
            ...
            <div className="space-y-3">
                ...
                <h1 className="text-xl font-semibold text-white capitalize dark:text-white">Simple & clean designs</h1>
