  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      ...
      <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div className="items-center bg-black rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="bril.jpg" alt="Bril" />
              </a>
              <div className="p-5">
          ...
          <div className="items-center bg-black rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                  ...
                  <p className="mt-3 mb-4 font-light text-white dark:text-white">Quentyn drives the research & development strategy of the Viccci platform.</p>
                  <ul className="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="#" className="text-blue-500 hover:text-gray-900 dark:hover:text-white">
                              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
          ...
          <div className="items-center bg-black rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://img1.wsimg.com/isteam/ip/c62ec2e6-ed0a-4c01-a452-434d38fb7244/307972599_2114008585448661_4875268806780398333.jpg/:/cr=t:4.18%25,l:0%25,w:100%25,h:73.93%25/rs=w:365,h:365,cg:true" alt="Michael Avatar" />
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                  ...
                  <p className="mt-3 mb-4 font-light text-whit dark:text-white">TJ drives the social media as well as research & development of Viccci.</p>
                  <ul className="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="#" className="text-blue-500 hover:text-gray-900 dark:hover:text-white">
                              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
          ...
          <div className="items-center bg-black rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://scontent-lga3-1.xx.fbcdn.net/v/t39.30808-6/241165253_4167628113346339_3194721462302721637_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=174925&_nc_ohc=JINhVOQ46gUAX9cGwNY&_nc_ht=scontent-lga3-1.xx&oh=00_AfCDbAT0lu_BzfnyzUR9B4FNOURwQ8pn6VuFIHVP8TzvNw&oe=63E8DBFB" alt="Quan Adams" />
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                  ...
                  <p className="mt-3 mb-4 font-light text-white dark:text-white">Quan is the lead artist of the Viccci platform and brand.</p>
                  <ul className="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="#" className="text-blue-500 hover:text-gray-900 dark:hover:text-white">
                              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
