  ...
  return (
    ...
    <div className="flex flex-col">
        ...
        <div className="sm:w-[80%] xs:w-[90%] mx-auto flex">
            <img src="/zo.jpg" alt="User Profile"
        ...
        <div
            ...
            Alfonzo Hamlin was born and raised in Richmond, VA. After graduating high school as valedictorian, he attended Norfolk State 
            University and studied Computer Science with a full academic scholarship. While in college, Alfonzo started his career in sales.
            Shortly after school, he started working as an insurance producer with the top insurance agency in the US where he learned many 
            entrepreneurial skills. After working over 10 years in sales and marketing, Alfonzo opened his own insurance agency and used his
            entrepreneurial and sales skills to become a top producing agent in the Carolinas. With Alfonzo’s background in sales and 
            marketing, his knowledge in computer science, and his passion to help build a greater community, Alfonzo is a great addition to 
            the Viccci Protocol team.</p>
                    ...
                    <div className="w-full">
                        <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            <div className="flex flex-col pb-3">
                                ...
                                <dd className="text-lg font-semibold">Alfonzo Hamlin</dd>
                            </div>
