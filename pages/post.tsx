...
const Post = () => {
  return (
    <div>
        <SEO title={"Viccci Protocol Blog Posts"} 
      ...
      <div className="relative px-4 pt-12 pb-16 sm:px-6 sm:pt-16 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div className="lg:col-start-2 lg:pl-8">
          <div className="mx-auto max-w-prose text-base lg:ml-auto lg:mr-0 lg:max-w-lg">
            <h2 className="font-semibold leading-6"><span className='blue'>Crypto 101</span></h2>
            <h3 className="mt-2 text-3xl font-bold leading-8 tracking-tight text-white sm:text-4xl">Blockchain & Cryptocurrency</h3>
    ...
    <div className="relative overflow-hidden bg-black py-16">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-prose text-lg">
          ...
          <span className="mt-2 block text-center text-3xl font-bold leading-8 tracking-tight blue sm:text-2xl">
              Vitalik Buterin
            </span>
        </div>
        <br/>
        <div className="prose prose-lg prose-indigo mx-auto mt-6 text-white">
          <p>
          ...
          <figure>
            ...
            <img
              ...
              src="https://d16kd6gzalkogb.cloudfront.net/magazine_images/Blockchain-design-by-Dadiani-Fine-Art.jpg"
              alt=""
              width={1310}
              height={873}
            />
